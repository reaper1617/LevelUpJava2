package ru.gerasimchuk.homework4dao;

import ru.gerasimchuk.homework4dao.dao.EmployeeDao;
...
public class JDBCMain {
    public static void main(String[] args) {
        ...
        Configuration.init(System.getProperty("user.dir") + "\\src\\main\\java\\ru\\gerasimchuk\\homework4dao\\.properties");
